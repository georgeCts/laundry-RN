const Logo = require('../assets/imgs/laundry-logo.jpeg');
const Logo_Transparent = require('../assets/imgs/laundry-logo.png');
const ProfileBackground   = require('../assets/imgs/tayd-lights.jpg');
const ProfilePicture      = require('../assets/imgs/profile-img.jpg');

const LoginRegistro = require('../assets/imgs/login_registro.png');
const RequestService = require('../assets/imgs/solicitud-servicio.png');
...
const Icons = {
  ...
  Servicio_normal : require('../assets/icons/servicio-normal.png'),
  Servicio_express : require('../assets/icons/servicio-express.png'),
